...
export default function ProductCard({ product }: ProductCardProps) {
    return (
        <ClickSpark
            sparkColor="#ff6b00"  // Bright orange - very visible!
            sparkSize={15}
            sparkRadius={40}
            sparkCount={10}
            duration={600}
        >
            <Card className="group overflow-hidden border-none shadow-md hover-lift hover:animate-float transition-all duration-300">
